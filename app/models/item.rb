class Item < ApplicationRecord
  with_options presence: true do
    ...
    validates :item_price, format: { with: /\A[0-9]+\z/, message: 'には半角英数字を入力してください', allow_blank: true },
                           numericality: { greater_than_or_equal_to: 300, less_than_or_equal_to: 9_999_999, message: 'には300~9999999の範囲で入力してください', allow_blank: true }
  end
